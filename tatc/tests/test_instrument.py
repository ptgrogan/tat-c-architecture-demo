...
class TestInstrument(unittest.TestCase):
    def test_from_json_basic(self):
        ...
        self.assertEqual(sorted(o.operatingWavelength), sorted([443,482,561,655,865,1609,2201,590,1373,10900,12000]))
    ...
    def test_to_json_basic(self):
        ...
        self.assertEqual(sorted(d.get("operatingWavelength")), sorted([443,482,561,655,865,1609,2201,590,1373,10900,12000]))
